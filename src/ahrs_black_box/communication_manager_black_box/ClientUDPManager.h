...
namespace communication
{
    ...
    public:
        ...
        virtual const std::list<std::pair<std::shared_ptr<Client>, uint8_t > >& getClientList() = 0;
        virtual void insertNewClient(std::pair<std::shared_ptr<Client>, uint8_t > newClient) = 0;
