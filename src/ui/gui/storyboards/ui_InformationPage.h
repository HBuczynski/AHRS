...
public:
    ...
    void setupUi(QWidget *InformationPage)
    {
        ...
        m_comLabel->setMinimumSize(QSize(285, 0));
        m_comLabel->setMaximumSize(QSize(285, 16777215));
        ...
        r_comLabel->setMinimumSize(QSize(285, 0));
        r_comLabel->setMaximumSize(QSize(285, 16777215));
