...
void RTFusionMadgiwck::reset()
{

}

void RTFusionMadgiwck::newIMUData(RTIMU_DATA& data, const RTIMUSettings *settings)
{
...
void RTFusionMadgiwck::update(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz)
{
    float recipNorm;
    float s0, s1, s2, s3;
...
void RTFusionMadgiwck::computeAngles()
{
